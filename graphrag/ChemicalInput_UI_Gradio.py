...
def create_app():
    with gr.Blocks(title="Stream Composition Analyzer") as app:
        ...
        # Add custom JavaScript to enhance copy/paste functionality
        app.load(js="""
        function setupClipboard() {
            ...
            setTimeout(() => {
                // Try to enhance the paste functionality
                table.addEventListener('paste', function(e) {
                    // Custom paste handling can be implemented here if needed
